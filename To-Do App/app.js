...
const togggleTaskComplete = (index) => {
  tasks[index].completed = !tasks[index].completed;
  console.log({ tasks });
  updateTaskList(); // refresh list so styles & checked state update
  updateStats();
  saveTasks();
};
...
const updateTaskList = () => {
  ...
  tasks.forEach((task, index) => {
    ...
    // Attach listener directly to checkbox
    listItem.querySelector("input[type='checkbox']")
      .addEventListener("change", () => togggleTaskComplete(index));
